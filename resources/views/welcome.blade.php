        ...
        <div class="wrapper">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="http://127.0.0.1:8000/login" class="tbl-biru">Sign Up</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="tengah">
        ...
        <div class="partner-list">
            <div class="kartu-partner">
                <a href="#" class="partner-button" onclick="checkLogin('http://127.0.0.1:8000/makalahs/view');">
                    <img src="https://www.nicepng.com/png/full/10-101646_books-png.png"/>
                    <p>Makalah</p>
                </a>
            </div>
            <div class="kartu-partner">
                <a href="#" class="partner-button" onclick="checkLogin('http://127.0.0.1:8000/posters/view');">
...
<script>
    function checkLogin(targetUrl) {
        ...
        const isLoggedIn = false; // Ganti dengan logika pemeriksaan login yang sesuai

        if (isLoggedIn) {
            window.location.href = targetUrl; // Jika sudah login, arahkan ke URL yang dituju
        } else {
            alert('Silakan login terlebih dahulu untuk mengakses konten ini.'); // Peringatan jika belum login
            window.location.href = 'http://127.0.0.1:8000/login'; // Arahkan ke halaman login setelah alert ditutup
        }
    }
</script>
