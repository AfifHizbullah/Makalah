...
<body>
    ...
    <div class="create-button-container">
        <a href="{{ route('makalahs.create') }}">
            <button class="create-button"><i class="fas fa-plus"></i>Create Artikel</button>
        </a>
    </div>
            ...
            <td colspan="2">
                <div class="button-container">
                    ...
                    <form action="{{ route('makalahs.destroy', ['id' => $makalah->id]) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="delete-button" onclick="return confirm('Are you sure you want to delete this makalah?')"><i class="fas fa-trash"></i>Delete</button>
                    </form>
                </div>
            </td>
        </tr>
